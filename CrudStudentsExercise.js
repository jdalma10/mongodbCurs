...
printjson(db.students.findOne({})) //Find all students ordered by name 
...
printjson(db.students.insertMany([ { name: "Alice Smith", major: "Mathematics", gpa: 3.5 }, { name: "Bob Johnson", major: "Physics", gpa: 3.2 }, { name: "Charlie Brown", major: "English", gpa: 3.9 } ]))
...
printjson(db.students.updateMany( { major: "Biology" }, { $set: { status: "active" } } ) )
